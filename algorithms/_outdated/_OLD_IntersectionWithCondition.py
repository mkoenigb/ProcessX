...
class IntersectionWithCondition(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        for overlay_layer_field in overlay_layer_vl.fields():
        ...
        for current, source_feat in enumerate(source_layer_vl.getFeatures()):
            ...
            for i, overlay_feat_id in enumerate(bbox_intersecting):
                if feedback.isCanceled():
                    break
                ...
                if overlay_feat.geometry().intersects(source_feat_geom):
                    ...
                    if op is None:
                        ...
                        new_feat.setGeometry(source_feat_geom.intersection(overlay_feat.geometry()))
                        attridx = 0
    ...
    def createInstance(self):
        return IntersectionWithCondition()

    def name(self):
        return 'IntersectionWithCondition'

    def displayName(self):
        return self.tr('Intersection with condition')
    ...
    def shortHelpString(self):
        return self.tr('This Algorithm builds an intersection if a given condition is fullfilled.')